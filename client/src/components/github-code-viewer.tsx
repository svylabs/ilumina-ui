    ...
    <div className="flex flex-col h-full bg-black/90 rounded-md overflow-hidden">
      ...
      <div className="flex-grow min-h-0 flex flex-col">
        <Tabs defaultValue="files" className="flex flex-col h-full">
          ...
          <TabsContent value="files" className="flex-grow overflow-auto min-h-0 scrollbar">
            {isLoading ? (
          ...
          <TabsContent value="code" className="flex-grow min-h-0 flex flex-col overflow-hidden">
            {currentFile && (
              <>
                ...
                <div className="overflow-auto flex-grow min-h-0 scrollbar">
          ...
          {showCommits && (
            <TabsContent value="commits" className="flex-grow min-h-0 flex flex-col overflow-hidden">
              ...
              {isLoadingCommits ? (
                ...
                <div className="divide-y divide-gray-800 overflow-y-auto overflow-x-hidden flex-grow min-h-0 scrollbar">
                  {commits.map((commit) => (
