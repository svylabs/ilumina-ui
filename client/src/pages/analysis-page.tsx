...
export default function AnalysisPage() {
  ...
  const getStepStatus = (stepId: string): StepStatus => {
    // Special case for deployment step in demo
    if (stepId === "deployment" && selectedStep === "deployment") {
      return "completed";
    }
                      ...
                      {currentStep.id === "deployment" ? (
                        ...
                        <div className="text-white font-mono">
                          <div className="space-y-6">
                            ...
                            <div className="bg-gray-900 p-4 rounded-md">
                              <pre className="text-sm text-green-400 whitespace-pre-wrap">
                                {getStepDetails(currentStep.id) || `# Deployment Sequence for SmartContract System
...
3. Test initial market creation with test parameters` || "No deployment instructions available"}
                              </pre>
                            </div>
                          </div>
                        </div>
