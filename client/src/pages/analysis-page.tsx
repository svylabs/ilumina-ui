        ...
        <div className="flex justify-between items-center">
          <div className="flex flex-col">
            <h1 className="text-4xl font-bold bg-gradient-to-r from-primary to-primary/60 bg-clip-text text-transparent">
              {analysis && analysis.steps.files && analysis.steps.files.jsonData?.projectName || "Project"} Simulation
            </h1>
            {analysis && analysis.steps.files && analysis.steps.files.jsonData?.repoUrl && (
              <a href={analysis.steps.files.jsonData.repoUrl} target="_blank" rel="noopener noreferrer" className="text-blue-400 hover:text-blue-300 mt-1 text-sm">
                {analysis.steps.files.jsonData.repoUrl}
              </a>
            )}
          </div>
          <Button
